...
export default function GoogleSearchResult({ query, onSearch, onNavigate, darkMode }) {
    ...
    const paaItems = [
        ...
        },
        {
            ...
            a: "Praneeth Reddy works as a Software Developer & DevOps Engineer at Simnovus in Bengaluru, India. He is a full-stack developer with experience in building web applications and automation scripts."
        },
        {
