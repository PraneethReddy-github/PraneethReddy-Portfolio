...
export class Terminal extends Component {
    constructor() {
        ...
        this.file_contents = {
            ...
            "simnovus.txt": "Simnovus - Backend & Systems Engineer Intern\n\nAt Simnovus, the challenge was building highly scalable infrastructure for telecommunications network simulation. I designed and developed a robust distributed orchestrator using GoLang to automate the provisioning of 5G/LTE simulation environments across multi-host deployments. A major milestone was architecting a dynamic port allocation system that replaced legacy static configurations, vastly improving resource efficiency. Additionally, I implemented real-time performance telemetry using Redis and MySQL, allowing engineers to monitor latency-sensitive simulation nodes instantly.\n\n<a href='https://simnovus.com' target='_blank' class='text-ubt-blue underline'>Visit Simnovus Website</a>"
        };
        this.state = {
            terminal: [],
            viMode: false,
